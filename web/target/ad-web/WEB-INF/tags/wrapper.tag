...
<%@ attribute name="page_before" fragment="true" required="false" description="css file includes" %>
...
<head>
    ...
    <jsp:invoke fragment="page_before" />
</head>
<body>
...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            <li><a href="<c:url value="/" />">All Ads</a></li>
            <li><a href="<c:url value="/add" />">Post New</a></li>
        </ul>

        <div class="col-sm-5 col-md-5">
            <%--<form class="navbar-form" style="width:100%" action="<c:url value="/search" />" role="search">
